...
function TodoModal({
  ...
  return (
    <div className="flex items-start justify-center fixed top-0 left-0 h-screen w-full overflow-y-scroll z-10 bg-opacity-25 bg-black">
      <div className="bg-white rounded-lg dark:bg-gray-800 shadow-md p-6 w-11/12 max-w-3xl text-left mx-auto my-12">
        <div className="flex justify-between text-lg mb-4">
          <div className="text-opacity-60 font-bold uppercase">
            Update this todo
          </div>
